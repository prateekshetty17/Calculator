...
Z = Button(top, text = "Clear", command = all_clear).grid(row = 5, column = 0)
...
Z = Button(top, text = "Clear", command = clear).grid(row = 9, column = 0)
...
Z = Button(top, text = "Clear", command = clear1).grid(row = 5, column = 3)
...
Z = Button(top, text = "Clear", command = clear2).grid(row = 9, column = 3)
...
Z = Button(top, text = "Clear", command = clear3).grid(row = 13, column = 0)
...
Z = Button(top, text = "Clear", command = clear4).grid(row = 13, column = 3)
L = Button(top, text = "***Thank You***", command = clear5).grid(row = 14, column = 2)
top.mainloop()
